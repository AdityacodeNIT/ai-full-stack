...
const ProctoringSystem = ({ interviewWS, videoElement }) => {
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            <div className="flex items-center">
              <div
                className={`w-2 h-2 rounded-full mr-2 ${videoElement ? "bg-green-500 animate-pulse" : "bg-yellow-500"}`}
              />
              <span className="text-sm text-gray-300">
                {videoElement ? "Proctoring Active" : "Initializing..."}
              </span>
            </div>
            {violations.length > 0 && (
              <button
              ...
              {violations.map((v, idx) => (
                ...
                >
                  <span>
                    ...
                    {v.type === "suspicious_object" &&
                      ` Suspicious: ${v.details?.objects}`}
                  </span>
